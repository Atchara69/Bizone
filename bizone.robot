...
Gmail_No_4
    ...
    ...              AND   Set Selenium Speed  ${SELSPEED}
    # open    https://bizone.chat/
    click    xpath=//div[@id='root']/div/div/main/div/div[2]/div/div[3]/div
...
Gmail_N0_9
    ...
    # open    https://bizone.chat/
    click    xpath=//div[@id='root']/div/div/main/div/div[2]/div/div[3]/div/a/i
    click    xpath=//div[@id='view_container']/div/div/div[2]/div/div/div/form/span/section/div/div/div/div/ul/li[4]/div/div/div[2]
...
register_14
    ...
    type    name=tid    amsat903@hotmail.com
    click    name=tpasswd
    type    name=tpasswd    1234567812345678
    [Teardown]  Close Browser
